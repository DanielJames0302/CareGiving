    ...
    <div className="user-activity-dashboard">
      <div className="menu-options">
        <div className="menu-list">
          <button
            className={option === 0 ? "option-btn chosen" : "option-btn"}
            onClick={() => setOption(0)}
          >
            {" "}
            Current Activities
          ...
          <button
            className={option === 1 ? "option-btn chosen" : "option-btn"}
            onClick={() => setOption(1)}
          >
            {" "}
            Past Activities
          ...
          : pastActivities.map((item, id) => (
              <div key={id} className="activity-item">
                ...
                <Button
                  className="mx-3"
                  variant="success"
                  onClick={() => handleCertificateRequest(item)}
                >
