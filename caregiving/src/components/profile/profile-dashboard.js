        ...
        {isEdit === false ? <Button variant='warning' onClick={() => setIsEdit(true)}>Edit</Button> : <Button variant='danger' onClick={() => setIsEdit(false)}>Stop edit</Button>}
          ...
          <h1 className='onboarding-form-title'>Volunteer onboarding</h1>
           ...
           <Row className="mb-3">
            <Form.Group as={Col} controlId="formGridName" >
              ...
              <Form.Control name='name' value={userInfo?.name} type="text" placeholder="Enter your name" onChange={handleChange} required/>
            </Form.Group>

            <Form.Group as={Col} controlId="formGridWhatsappPhoneNumber">
              <Form.Label>Whatsapp phone number</Form.Label>
              <Form.Control name='phone' value={userInfo?.phone} type="text" placeholder="Whatsapp phone number" onChange={handleChange} required />
            </Form.Group>
          </Row>
          <Row className="mb-3">
            <Form.Group as={Col} controlId="formGridGender">
                <Form.Label>Gender</Form.Label>
                <Form.Select name='gender' value={userInfo?.gender}  onChange={handleChange} required>
            ...
            <Form.Group as={Col} controlId="formGridGender">
                ...
                <Form.Control name="dateOfBirth" value={userInfo?.dateOfBirth} type="date" placeholder="Whatsapp phone number" onChange={handleChange} required />
            </Form.Group>
          ...
          <Row className="mb-3">
            <Form.Group as={Col} controlId="formGridOccupation">
                  ...
                  <Form.Select name='occupation' value={userInfo?.occupation} defaultValue="Choose..." onChange={handleChange} required>
                    <option value=''>Choose...</option>
              ...
              <Form.Group className="mb-3" controlId="formGridEducationLevel">
                ...
                <Form.Control required name='education' value={userInfo?.education} type='name' placeholder="Educational Level" onChange={handleChange}  />
              </Form.Group>: ''}
          ...
          <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridResidentialStatus">
                  ...
                  <Form.Select name='residentialStatus' value={userInfo?.residentialStatus} required onChange={handleChange}>
                    <option value=''>Choose...</option>
          ...
          <Row className="mb-3">
            <Form.Group as={Col} controlId="formGridDriving">
                  ...
                  <Form.Select required name='driving' value={userInfo?.driving} onChange={handleChange} >
                    <option value=''>Choose...</option>
              ...
              <Form.Group as={Col} controlId="formGridVehicle">
                  ...
                  <Form.Select name='ownVehicle' value={userInfo?.ownVehicle} onChange={handleChange} required>
                    <option value=''>Choose...</option>
                    <option value={true}>Yes</option>
                    <option value={false}>No</option>
                  </Form.Select>
