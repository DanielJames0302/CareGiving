  ...
  const handleFormSubmit = async (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      if (!isLoading) {
        setIsLoading(true);
        try {
          const imgUrl = `/activities/${activity.name}/${
            activity.name
          }-${v4()}`;
      ...
      <Form noValidate validated={validated} onSubmit={handleFormSubmit}>
        ...
        <Form.Group className="my-3" as={Col}>
          ...
          <CreatableSelect
            ...
            value={activityGoals}
            isMulti={true}
            onChange={handleChangeActivityGoals}
            required
          />
        </Form.Group>
        ...
        <Form.Group controlId="formFile" className="mb-3">
          <Form.Label>
            <strong>Upload image for activity</strong>
          </Form.Label>
          <Form.Control
            type="file"
          ...
          <div className="form-message">
            ...
            {isSuccess && (
              <p className="text-success">
                {" "}
                <strong>Activity created successfully!</strong>
              </p>
            )}
          </div>
        </div>
